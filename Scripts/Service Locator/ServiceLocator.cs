...
public partial class ServiceLocator : Node, IAutoload {
    ...
    private static ServiceName _ConvertToEnum(Type objectType) {
        ...
        return objectType switch {
            ...
            not null when objectType == typeof(KitchenService) => ServiceName.KitchenService,
        };
    }
    ...
    private void _InstantiateServices() {
        ...
        AddService(ServiceName.KitchenService, new KitchenService(inventoryService, playerDataRepository), false);
    }
}